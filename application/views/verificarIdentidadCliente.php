...
<head>
    ...
    <link rel="stylesheet" href="../../assets/image-picker/css/image-picker.css">
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center browsers">
                            ...
                            <div class="col-sm-3">
                                <img src="../../assets/img/opera.svg" class="opera" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="tab-content">
                                        ...
                                        <fieldset id="document">
                                            ...
                                            <!-- <div class="picker" style="margin: 0 auto;text-align: center;display: table;">
                                                <select id="documentType" class="image-picker show-labels show-html">
                                                    <option value=''></option>
                                                    <option data-img-src='../../assets/img/ci_back.png' value='CHL2'>Cédula Nueva</option>
                                                    <option data-img-src='../../assets/img/ci_antigu_reverso.jpg' value='CHL1'>Cédula Antigua</option>
                                                </select>
                                            </div> -->
                                    ...
                                    <div class="tab-pane fade" role="tabpanel" id="front">
                                        <fieldset id="front">
                                            ...
                                            <img class="check-orientation" style="width:15%; display:none;" src="../../assets/img/doc-ok.PNG" alt="">
                                            <div class="image">
                                                <div class="row">
                                                    <div class="col-1">
                                    ...
                                    <div class="tab-pane fade" role="tabpanel" id="back">
                                        <fieldset id="back">
                                            ...
                                            <img class="check-orientation" style="width:15%; display:none;" src="../../assets/img/doc-back-ok.PNG" alt="">
                                            <div class="image">
                                                <div class="row">
                                                    <div class="col-1">
                                                        <a href="javascript:void(0);" data-dir="left" class="btn btn-sm btn-dark rotate float-left">
    ...
    <script src="../../assets/shards-1.1/js/shards.min.js"></script>
    <script src="../../assets/jquery-bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
    <script src="../../assets/bootbox-v4.4.0/bootbox.min.js"></script>
    <script src="../../assets/momentjs-2.18.1/moment.min.js"></script>
    ...
    <script src="../../assets/scripts/ci_codes.js"></script>
    <script src="../../assets/locale/lang.js"></script>
    <script src="../../assets/scripts/status.js"></script>
    <script src="../../assets/scripts/toc_utils.js"></script>
    <script src="../../assets/scripts/ui_interactions.js"></script>
