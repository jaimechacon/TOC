	...
	<div class="col-sm-12">
		...
		<div class="row">
				...
				<div class="row">			
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="col-sm-9">
								<select id="institucionAsignacion" class="custom-select custom-select-sm">
					...
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="col-sm-9">
								<select id="hospitalAsignacion" class="custom-select custom-select-sm">
								    <option value="-1">Todos</option>
									<?php 
									if($hospitales)
									{
			...
			<div class="col-sm-12 pt-3">
				<div class="row">			
					<div class="col-sm-12 text-left">
						<p id="itemSeleccion" data-id="<?php echo $itemSeleccion["id_item"]; ?>" data-nombre="<?php echo $itemSeleccion["nombre"]; ?>" data-codigo="<?php echo $itemSeleccion["codigo"]; ?>" data-idCuenta="<?php echo $idCuenta; ?>">Item Seleccionado: <?php echo $itemSeleccion["codigo"].' '.$itemSeleccion["nombre"]; ?></p>
					</div>
				</div>
			</div>
										...
										if($reporteResumen['nombre'] == "Total" )
										{
											...
											echo '<tr>
													...
													<td class="text-center">
														<button type="button botonTabla" class="btn btn-link redireccionarSubAsignacion botonTabla" data-id="'.$reporteResumen["id_asignacion"].'"><i data-feather="search" class="trash"></i></button>
														<!--<a href="'.base_url().'Reporte/listarReportesSubAsignacion/?idAsignacion='.$reporteResumen['id_asignacion'].'" title="click para ver detalle de asignacion"><i data-feather="search" class="trash"></i></a>-->
													</td>
													</tr>';
										}
									}
											...
											echo '<tr>
												...
												echo '<tr>
													...
													<td class="text-center botonTabla">
														<button type="button botonTabla" class="btn btn-link redireccionarSubAsignacion botonTabla" data-id="'.$reporteResumenGasto["id_asignacion"].'"><i data-feather="search" class="trash"></i></button>
														<!--<a href="'.base_url().'Reporte/listarReportesSubAsignacion/?idAsignacion='.$reporteResumenGasto['id_asignacion'].'" title="click para ver detalle de asignacion"><i data-feather="search" class="trash"></i></a>-->
													</td>
													</tr>';
											}
										}
			...
			<div id="botones" class="row m-3">
				<button type="button" class="btn btn-link redireccionarItem" data-id="<?php echo $itemSeleccion["id_item"]; ?>"><i data-feather="chevron-left" class="trash"></i> Volver</button>
